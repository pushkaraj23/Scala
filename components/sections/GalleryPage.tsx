    ...
    return (
        ...
        >
            ...
            >
                ...
                {/* Info Panel */}
                <div className="lg:w-72 xl:w-80 flex-shrink-0 bg-slate-800/50 backdrop-blur-xl border border-slate-700/50 rounded-2xl p-4 sm:p-6 overflow-y-auto max-h-[30vh] lg:max-h-full">
                    {/* Category Badge */}
                    <div className="flex flex-wrap items-center gap-2 mb-4">
                        <span className="px-3 py-1.5 rounded-full bg-[#73b313]/10 text-[#c4ff6b] text-sm font-medium capitalize">
                            {item.category}
